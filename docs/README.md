...
| Paper structure build | `quantmind.flows.PaperFlow` | `open()`: `PaperInput`; `build_structure()`: `PaperStructureCfg` | `PaperStructureTree` (self-contained) | [Build and retrieve](../examples/mind/paper_structure_retrieval.py) | [Structure retrieval design](../contexts/design/mind/retrieval.md) |
| Reasoning-based retrieval | `quantmind.mind.retrieve` | one `StructureTree` + question, `RetrievalCfg` (no library) | `list[RetrievalEvidence]` | [Build and retrieve](../examples/mind/paper_structure_retrieval.py) | [Structure retrieval design](../contexts/design/mind/retrieval.md) |
