...
| Bounded fan-out | `quantmind.flows.batch_run` | Flow inputs and shared config | `BatchResult` | [README usage](../README.md#-usage-examples) | API docstrings |

Import public inputs and configs from `quantmind.configs` and agent-facing
...
| Source | Agent-facing selection | Operation | Live component gate |
|---|---|---|---|
