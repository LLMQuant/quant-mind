...
class TestEmbeddingConfig(unittest.TestCase):
    ...
    def test_create_variant(self):
        ...
        base_config = EmbeddingConfig(
            model="text-embedding-ada-002", timeout=60, batch_size=32
        )

        variant = base_config.create_variant(timeout=30, batch_size=16)
...
class TestEmbeddingBlock(unittest.TestCase):
    ...
    def test_update_config(self, mock_sentence_transformer):
        ...
        embedding_block.update_config(
            model="sentence-transformers/all-mpnet-base-v2"
        )
        self.assertEqual(
            embedding_block.config.model,
...
class TestCreateEmbeddingBlock(unittest.TestCase):
    ...
    def test_create_embedding_block(self):
        ...
        with patch(
            "quantmind.llm.embedding.SENTENCE_TRANSFORMERS_AVAILABLE", True
        ):
